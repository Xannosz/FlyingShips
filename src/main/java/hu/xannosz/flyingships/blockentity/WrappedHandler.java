...
public class WrappedHandler implements IItemHandlerModifiable {
	...
	private final BiPredicate<Integer, ItemStack> extract;
	private final BiPredicate<Integer, ItemStack> insert;

	public WrappedHandler(IItemHandlerModifiable handler, BiPredicate<Integer, ItemStack> extract,
	...
	public ItemStack extractItem(int slot, int amount, boolean simulate) {
		return this.extract.test(slot, handler.getStackInSlot(slot)) ? this.handler.extractItem(slot, amount, simulate) : ItemStack.EMPTY;
	}
