...
public class LoopBackEditBox extends EditBox {
	...
	private final ScreenWithButton screen;
	@Getter
	private boolean editable;

	public LoopBackEditBox(Font p_94114_, int p_94115_, int p_94116_, int p_94117_, int p_94118_, Component p_94119_, ButtonId buttonId, ScreenWithButton screen) {
