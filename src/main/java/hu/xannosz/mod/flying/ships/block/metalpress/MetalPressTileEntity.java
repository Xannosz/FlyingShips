package hu.xannosz.mod.flying.ships.block.metalpress;

import hu.xannosz.mod.flying.ships.crafting.recipe.PressingRecipe;
import hu.xannosz.mod.flying.ships.setup.ModRecipes;
import hu.xannosz.mod.flying.ships.setup.ModTileEntityTypes;
...
public class MetalPressTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.flying_ships.metal_press");
    }
