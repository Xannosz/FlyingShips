...
public class Registration {
    ...
    private static <T extends IForgeRegistryEntry<T>> DeferredRegister<T> create(IForgeRegistry<T> registry) {
        return DeferredRegister.create(registry, FlyingShipsMod.MOD_ID);
    }

    @Mod.EventBusSubscriber(value = Dist.CLIENT, modid = FlyingShipsMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
